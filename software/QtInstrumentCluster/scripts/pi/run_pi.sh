...
export IVI_SERIAL_FALLBACK="${IVI_SERIAL_FALLBACK:-0}"
...
echo "[INFO] IVI_SERIAL_FALLBACK=${IVI_SERIAL_FALLBACK}"
...
echo "[HINT] Invert Qt scene only: IVI_DISPLAY_ROTATION=180 ./scripts/pi/run_pi.sh"
