...
QtObject {
    // Core accent + status colors
    readonly property color highlighterGreen: "#4ade80"
    readonly property color highlighterRed: "#f87171"
    readonly property color brightBlue: "#3ab4ff"
    readonly property color lightPeriwinkle: "#cadfff"
    readonly property color darkBlue: "#001b4d"

    // Dashboard surfaces & text (unified background system)
    // Tông xám đậm giống template tham chiếu
    readonly property color backgroundBase: "#050608"       // full-screen background (gần đen, hơi xám)
    readonly property color backgroundPanel: "#181b20"      // main cards (left/right/bottom)
    readonly property color backgroundPanelSoft: "#252932"  // inner pills, gear selector, etc.
    readonly property color textPrimary: "#ffffff"
    readonly property color textSecondary: "#8aa6c1"
