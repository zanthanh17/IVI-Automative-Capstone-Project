...
/* USER CODE BEGIN PFP */
__attribute__((used)) static void HardFault_HandlerC(uint32_t *fault_stack_address);
...
__attribute__((used)) static void HardFault_HandlerC(uint32_t *fault_stack_address)
{
  g_hardfault_r0   = fault_stack_address[0];
  g_hardfault_r1   = fault_stack_address[1];
  g_hardfault_r2   = fault_stack_address[2];
  g_hardfault_r3   = fault_stack_address[3];
  g_hardfault_r12  = fault_stack_address[4];
  g_hardfault_lr   = fault_stack_address[5];
  g_hardfault_pc   = fault_stack_address[6];
  g_hardfault_psr  = fault_stack_address[7];
